...
export default function PickupTraveler() {
  ...
  const openChat = async () => {
    ...
    try {
      if (!params.requesterId || !params.travelerId || !params.idGood) {
        setStatusMessage({
          type: 'error',
          title: 'Error',
      ...
      {showSuggestions ? (
        ...
        <Pickups
          ...
          paramsData={{
            ...
            requesterName: params.requesterName as string || "Requester",
            travelerName: params.travelerName as string || "Traveler",
            goodsName: params.goodsName as string || "Item",
            status: params.status as string || "PENDING",
            reviewLabel: params.reviewLabel as string || "",
            isTraveler: params.isTraveler as string || "false"
          }}
        />
      ) : (
        <>
