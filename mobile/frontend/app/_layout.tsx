                ...
                <Provider store={store}>
                    {!loadingComplete ? (
                        ...
                        <Stack>
                            ...
                            <Stack.Screen name="onboarding/howYouHeard" options={{ title: "How You Heard" }} />
                            <Stack.Screen name="onboarding/selectCategories" options={{ title: "Select Categories" }} />
                            <Stack.Screen name="onboarding/customScreen" options={{ title: "Custom Screen" }} />
                            <Stack.Screen name="profile/change" options={{ title: "Change Password" }} />
                            <Stack.Screen name="profile/edit" options={{ title: "Edit Profile" }} />
                            <Stack.Screen name="profile/index" options={{ title: "Profile" }} />
                            <Stack.Screen name="messages/messages" options={{ title: "Messages" }} />
                            <Stack.Screen name="test/Terms&&Conditions" options={{ title: "Terms and Conditions" }} />
                            ...
                            <Stack.Screen name="test/Notification" options={{ title: "Verification" }} />
                            ...
                            <Stack.Screen name="processTrack/initializationSO" options={{ title: "Initialization" }} />
                            <Stack.Screen name="processTrack/initializationSP" options={{ title: "Initialization" }} />
                            <Stack.Screen name="processTrack/verificationSO" options={{ title: "Verification" }} />
                            <Stack.Screen name="processTrack/verificationSP" options={{ title: "Verification" }} />
                            <Stack.Screen name="processTrack/paymentSO" options={{ title: "Payment" }} />
                            <Stack.Screen name="processTrack/paymentSP" options={{ title: "Payment" }} />
                            <Stack.Screen name="processTrack/pickupSO" options={{ title: "Pickup" }} />
                            <Stack.Screen name="processTrack/pickupSP" options={{ title: "Pickup" }} />
                            <Stack.Screen name="test/role-test" options={{ title: "Role Test" }} />
                            <Stack.Screen name="test/order-details" />
                            <Stack.Screen name="processTrack/makeOffer" options={{ title: "Make Offer" }} />
                            <Stack.Screen name="screens/RequestSuccessScreen" options={{ title: "Request Created" }} />
