      ...
      <View style={styles.card}>
        ...
        >
          <ThemedText style={styles.intro}>
            Welcome to The Tribe! These Terms and Conditions ("Terms") govern
            your participation in our global sponsorship community. By joining
            our community, you agree to these Terms. Please read them carefully.
          </ThemedText>
          ...
          <View style={styles.section}>
            ...
            <ThemedText style={styles.sectionText}>
              The Tribe is a global community that connects sponsors with
              individuals seeking access to digital content. We facilitate these
              connections and handle monetary transactions through third-party
              payment processors. Our platform enables cultural exchange and
              access to resources across borders.
            </ThemedText>
          </View>
          ...
          <View style={styles.section}>
            ...
            <ThemedText style={styles.sectionText}>
              To join our community, you must:
            </ThemedText>
          ...
          <View style={styles.section}>
            ...
            <ThemedText style={styles.sectionText}>
              To ensure the safety and integrity of our community, all members
              must complete a verification process that includes:{"\n"}•
          ...
          <View style={styles.section}>
            ...
            <ThemedText style={styles.listItem}>
              • Provide accurate information about your sponsorship offers.
            </ThemedText>
            <ThemedText style={styles.listItem}>
          ...
          <View style={styles.section}>
            ...
            <ThemedText style={styles.sectionText}>
              ...
              Policy. By accepting these Terms, you consent to our data
              practices, including:{"\n"}• Collection of verification
              information{"\n"}• Sharing necessary data with other community
              members{"\n"}• Processing payment information through secure
          ...
          <View style={styles.section}>
            ...
            <ThemedText style={styles.sectionText}>
              All content on our platform, including logos, text, and graphics,
              is protected by intellectual property rights. You may not use,
          ...
          <View style={styles.section}>
            ...
            <ThemedText style={styles.sectionText}>
              We provide our platform "as is" without warranties of any kind. We
          ...
          <View style={styles.section}>
            ...
            <ThemedText style={styles.sectionText}>
              We reserve the right to suspend or terminate your membership at
              any time for violations of these Terms. You may also terminate
              your membership by contacting our support team.
            </ThemedText>
          </View>
          ...
          <View style={styles.section}>
            ...
            <ThemedText style={styles.sectionText}>
              These Terms are governed by the laws of Tunisia. Any disputes will
