...
import { Home, Package, ShoppingBag, MapPin, Calendar, CheckCircle } from 'lucide-react-native';
    ...
    <ThemedView style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <ThemedText style={styles.description}>
          Your order has been successfully placed. A traveler will be bringing your item soon!
        </ThemedText>
        
        <View style={styles.orderCard}>
          <View style={styles.orderHeader}>
            <ShoppingBag size={20} color="#3b82f6" />
            <ThemedText style={styles.orderHeaderText}>Order #{orderId}</ThemedText>
          </View>
        ...
        <View style={styles.tipCard}>
          ...
          <ThemedText style={styles.tipText}>
            You can track the status of your order in the Orders section. Make sure to stay in touch with your traveler!
          </ThemedText>
        </View>
