...
export default function RoleTest() {
  const { user } = useAuth();
  const { role, loading } = useRoleDetection(user?.id ? parseInt(user.id) : undefined);
          ...
          <View style={styles.roleCard}>
            ...
            {role === 'SHOPPER' && (
              <Text style={styles.roleDescription}>
                You are a Shopper. You can create orders for travelers to fulfill.
              </Text>
            )}
            {role === 'TRAVELER' && (
              <Text style={styles.roleDescription}>
                You are a Traveler. You can find orders to deliver while traveling.
              </Text>
            )}
            {role === 'BOTH' && (
              <Text style={styles.roleDescription}>
                You are both a Shopper and a Traveler. You can create orders and deliver for others.
              </Text>
            )}
            {role === 'NONE' && (
              <Text style={styles.roleDescription}>
