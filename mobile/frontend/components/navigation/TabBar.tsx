...
export function TabBar({ activeTab, onTabPress }: {
  ...
  const tabs: TabItem[] = [
    { name: 'Home', icon: <Home size={24} color={iconColor} />, route: "/home" as Route },
    { name: 'Orders', icon: <ShoppingBag size={24} color={iconColor} />, route: "/productDetails/create-order" as Route },
    { name: 'Trips', icon: <Plane size={24} color={iconColor} />, route: "../test/Travel" as Route },
    { name: 'Pick-up', icon: <MapPin size={24} color={iconColor} />, route: "/mapTrack" as Route },
    { name: 'Messages', icon: <MessageCircle size={24} color={iconColor} />, route: "/test/chat" as Route },
  ];
