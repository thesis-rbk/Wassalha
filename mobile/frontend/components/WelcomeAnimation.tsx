...
export default function WelcomeAnimation({
  ...
  useEffect(() => {
    ...
    titleY.value = withDelay(
      300,
      withSpring(0, { damping: 12, stiffness: 100, mass: 0.8 })
    );
  ...
  return (
    <View style={styles.container}>
      <Animated.View style={[styles.background, backgroundStyle]}>
        <Image
          source={require("../assets/images/welcomeAnimation/worldwide-shipping.png")}
          style={styles.backgroundImage}
          resizeMode="contain"
        />
        <LinearGradient
          colors={["rgba(0, 91, 181, 0.3)", "rgba(51, 156, 255, 0.3)"]}
          start={{ x: 0, y: 0 }}
          end={{ x: 1, y: 1 }}
