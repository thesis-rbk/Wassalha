...
const { getGoodsPosts, createGoodsPost, updateGoodsPost, deleteGoodsPost, getUserGoodsPosts } = require("../controllers/goodsPost.controller");
...
// Route to fetch goods posts for a specific user
router.get("/user/:userId", getUserGoodsPosts);
