...
const chatService = {
   ...
   */
  async createMessage(chatId, senderId, content, type = 'text', mediaId = null) {
    ...
    const receiverId = chat.requesterId === senderId ? chat.providerId : chat.requesterId;
  ...
  async markMessagesAsRead(chatId, userId) {
    ...
    const io = getIO();
    io.of('/chat').to(`chat_${chatId}`).emit('message_read', { 
      chatId: parseInt(chatId), 
      readBy: userId,
      count: result.count
    });
